...
while not serial_input.isnumeric() or int(serial_input) > 2:
...
while not parallel_input.isnumeric() or int(parallel_input) > 2:
...
while not batteries_input.isnumeric() or int(batteries_input) > 2:
...
while wire_number <= 6:
	...
	while not led_input.isnumeric() or int(led_input) > 2:
	...
	while not color_input.isnumeric() or int(color_input) > 4:
	...
	while not star_input.isnumeric() or int(star_input) > 2:
